...
export class TestEntryScreen implements Screen {
    ...
    public title: string = 'Test Tools';
    ...
    private renderButtons(): void {
        ...
        const sceneButtons: SidebarButton[] = [
            ...
            this.createRouteButton('Scene Sandbox', 'Open a map sandbox where units can be placed manually', '/scenesandbox'),
            this.createRouteButton('Performance Test', 'Open the performance benchmark tool', '/perftest'),
            this.createBackToCategoriesButton(),
            this.createBackToMenuButton()
        ];
