...
export class AudioSystem {
    ...
    private updateMasterGain(): void {
        if (!this.channels.has(ChannelType.Master)) return;
        ...
        masterChannel.gain.value = baseVolume * this.masterVolumeScale;
    }
